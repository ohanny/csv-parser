...
//      `fetch` to load a module.
    ...
    function resolve(identifier) {
        ...
        //console.log(identifier + " => " + m[2]); // identifie . dans ./xxx
        //console.log(identifier + " => " + p[1]);// l'index 0 dans {id: "0:antlr4/index", uri: "http://localhost:63342/diapos/diapos-parser/antlr4/index.js"}
        //console.log(identifier + " => " + m[2]?"xx":"rien");
        //console.log(m[5]);
        ...
        //console.log((m[2]?root+p[2]+m[2]+'/':root)+m[3]+(m[4]?m[4]:'index'));
