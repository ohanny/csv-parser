...
var ruleNames =  [ "document", "hdr", "row", "field" ];
...
function DocumentContext(parser, parent, invokingState) {
    ...
    this.parser = parser;
    this.ruleIndex = CSVParser.RULE_document;
    return this;
}
...
DocumentContext.prototype.hdr = function() {
...
DocumentContext.prototype.row = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
CSVParser.DocumentContext = DocumentContext;

CSVParser.prototype.document = function() {

    var localctx = new DocumentContext(this, this._ctx, this.state);
    this.enterRule(localctx, 0, CSVParser.RULE_document);
